...
export const de: Record<TranslationKey, string> = {
  ...
  panelPlayitSecretLabel: 'Playit.gg Panel-Geheimschlüssel',
  panelPlayitSecretDesc: 'Geheimschlüssel, um das Minepanel-Dashboard öffentlich über playit.gg freizugeben.',
  ngrokAuthtokenLabel: 'Ngrok Authtoken',
  ngrokAuthtokenDesc: 'Authtoken, um das Minepanel-Dashboard öffentlich über ngrok freizugeben.',
