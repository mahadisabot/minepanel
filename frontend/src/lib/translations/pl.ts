...
export const pl: Record<TranslationKey, string> = {
  ...
  panelPlayitSecretLabel: 'Klucz Prywatny Panelu Playit.gg',
  panelPlayitSecretDesc: 'Klucz prywatny do publicznego udostępnienia panelu Minepanel przez playit.gg.',
  ngrokAuthtokenLabel: 'Ngrok Authtoken',
  ngrokAuthtokenDesc: 'Authtoken do publicznego udostępnienia panelu Minepanel przez ngrok.',
